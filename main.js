...
//     // .call(zoom.event);
    ...
    var annotation = svg.append("g")
        ...
        svg.append("text")
                    .text("TX,CA & FL reported highest fatalities. But if you observe, most eastern states also fall in the red zone that reported most fatalities.")
                    .attr("x",500)
                    .attr("y",470)
    ...
    var annotation2 = svg.append("g")
             ...
             svg.append("text")
                        .text("Northern states like NE, MT, ND and IA reported highest prevalence i.e. people who reported driving after drinking too much.")
                        .attr("x", 200)
                        .attr("y",470)
                        .attr("text-anchor","middle")
                        .attr("font-size", "12px")
...
var legendText = ["Fatalities:124-1000", "Fatalities:1001-2000", "Fatalities:2001-4000","Fatalities:4001-7000",
"Fatalities:>7000","Fatalities:10970-13138"];
